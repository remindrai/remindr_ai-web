...
export function ProfileDialog({ open, onOpenChange, profile, onSave }: ProfileDialogProps) {
  ...
  const isSomeActionChecked = (action: string) => {
    return permissions.some(
      (permission) => permission[action as keyof Permission] === true && !isAllActionChecked(action),
    )
  }
                ...
                <div className="flex flex-1 overflow-hidden">
                  ...
                  <div className="flex-1 overflow-auto p-4">
                    <h3 className="text-sm font-medium mb-4">
                      Select the actions that this profile allows for {selectedFeature}
                    </h3>
